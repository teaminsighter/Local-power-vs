...
const GoogleAds = () => {
  ...
  const [accounts] = useState<GoogleAdsAccount[]>([
    {
      id: '123-456-7890',
      name: 'Local Power - Solar Campaigns',
      currency: 'EUR',
      status: 'active',
      spend_last_30_days: 8450,
      conversions_last_30_days: 187,
      connected: true
    },
    {
      id: '098-765-4321',
      name: 'Local Power - Battery Ads',
      currency: 'EUR',
      status: 'active',
      spend_last_30_days: 3200,
      conversions_last_30_days: 64,
      connected: true
    }
  ]);

  // Mock conversion actions
  const [conversions] = useState<ConversionAction[]>([
    {
      id: 'conv_001',
      name: 'Solar Calculator Form Submit',
      type: 'lead',
      value: 50,
      count_last_30_days: 156,
      status: 'active'
    },
    {
      id: 'conv_002',
      name: 'Quote Request Completed',
      type: 'lead',
      value: 75,
      count_last_30_days: 89,
      status: 'active'
    },
    {
      id: 'conv_003',
      name: 'Phone Call - Solar Inquiry',
      type: 'call',
      value: 100,
      count_last_30_days: 34,
      status: 'active'
    },
    {
      id: 'conv_004',
      ...
      {activeTab === 'overview' && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { title: 'Total Spend', value: '€11,650', change: '+12.3% vs last month', color: 'blue' },
              { title: 'Conversions', value: '251', change: '+18.7% increase', color: 'green' },
              { title: 'Cost per Lead', value: '€46.42', change: '-8.2% improvement', color: 'purple' },
              { title: 'ROAS', value: '4.2x', change: '+0.6x vs last month', color: 'yellow' }
            ].map((metric, index) => (
              <motion.div
                key={metric.title}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              {[
                {
                  type: 'optimization',
                  title: 'Increase Budget for Solar Calculator Campaign',
