...
const FacebookAds = () => {
  ...
  const [accounts] = useState<FacebookAdAccount[]>([
    {
      id: 'act_123456789',
      name: 'Local Power Solar Ads',
      currency: 'EUR',
      status: 'active',
      spend_last_30_days: 5650,
      results_last_30_days: 142,
      connected: true
    },
    {
      id: 'act_987654321',
      name: 'Local Power Brand Awareness',
      currency: 'EUR',
      status: 'active',
      spend_last_30_days: 2300,
  ...
  // Mock Pixel Events
  const [pixelEvents] = useState<PixelEvent[]>([
    {
      id: 'evt_001',
      name: 'Lead - Solar Calculator',
      event_type: 'Lead',
      server_side: true,
      browser_side: true,
      events_last_30_days: 234,
      ...
      {activeTab === 'overview' && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { title: 'Total Spend', value: '€7,950', change: '+15.2% vs last month', color: 'blue' },
              { title: 'Results', value: '231', change: '+24.1% increase', color: 'green' },
              { title: 'Cost per Result', value: '€34.42', change: '-7.3% improvement', color: 'purple' },
              { title: 'ROAS', value: '3.8x', change: '+0.4x vs last month', color: 'yellow' }
            ].map((metric, index) => (
              <motion.div
                key={metric.title}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div className="text-2xl font-bold text-green-900 mb-1">491</div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div className="text-2xl font-bold text-blue-900 mb-1">8.2/10</div>
              ...
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <div className="text-2xl font-bold text-purple-900 mb-1">12.8%</div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input 
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                    defaultValue="insighter-digital-v1.0"
                    disabled
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 border border-gray-200 rounded-lg">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">Event Match Quality: Good (8.2/10)</h4>
